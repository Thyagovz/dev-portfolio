...
type PageDocumentDataSlicesSlice =
  ExperienceSlice | TechListSlice | RichTextSlice | BiographySlice | HeroSlice;
...
export type AllDocumentTypes =
  BlogpostDocument | PageDocument | RichtextDocument | SettingsDocument;
